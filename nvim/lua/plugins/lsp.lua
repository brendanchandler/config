return {
    ...
    },
    {
        ...
        config = function()
            -- LSP keymaps set once per buffer via LspAttach (modern pattern)
            ...
            -- nvim-lspconfig ships lsp/ configs that neovim picks up from rtp
            -- automatically; we only need to merge capabilities and enable.
